...
class Action:
    ...
    def perform(self) -> None:
        ...
        This method must be overridden by Action subsclasses
        '''
...
class PickupAction(Action):
    '''
    Pickup an item and add it to inventory, if there's room for it
    '''
...
class ActionWithDirection(Action):
    ...
    def dest_xy(self) -> Tuple[int, int]:
        '''
        Returns this action's direction.
        '''
...
class MovementAction(ActionWithDirection):
    def perform(self) -> None:
        ...
        if not self.engine.game_map.in_bounds(dest_x, dest_y):
            raise exceptions.Impossible("That way is blocked.")      # Destination is outside the map.
